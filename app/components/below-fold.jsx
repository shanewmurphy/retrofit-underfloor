  ...
  return (
    <div>
      <div className="bg-zinc-800 self-stretch flex w-full flex-col justify-center items-stretch lg:py-11 max-md:max-w-full">
        <div className="flex-col stroke-bg overflow-hidden relative z-0  flex min-h-[425px] w-full justify-center items-stretch px-16 py-12 max-md:max-w-full max-md:px-5">
