export default function BelowFoldSection() {
  return (
    <div>
      <div className="bg-zinc-100 self-stretch flex w-full flex-col justify-center items-stretch lg:py-11 max-md:max-w-full">
            ...
            <div className="gap-12 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
              <div className="flex flex-col items-stretch w-[54%] max-md:w-full max-md:ml-0">
                <div className="relative flex grow flex-col items-stretch max-md:max-w-full max-md:mt-10">
                  ...
                  <div className="text-lightgrey font-semibold mt-2 max-md:max-w-full">
                    <h5>
              ...
              <div className="flex flex-col items-stretch w-[46%] ml-5 max-md:w-full max-md:ml-0">
                <div className="leading-6 relative my-auto max-md:max-w-full max-md:mt-10">
                  <p className="text-mygrey font-medium">
                    Our floorgrinder creates 16mm channels for the heating
